...
func (f *Filebase) WriteTo(w io.Writer) (int, error) {
	return w.Write(f.BytesIndent())
}

func (f *Filebase) WriteToFile(filename string) (int, error) {
